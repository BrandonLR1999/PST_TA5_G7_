...
public class Adaptador2 extends BaseAdapter  {
    ...
    public Adaptador2 (Context contexto, String [][] datos, int[] imagenes){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        //String imageUrl = "https://estaticos.muyinteresante.es/media/cache/760x570_thumb/uploads/images/article/5c3871215bafe83b078adbe3/perro.jpg";
